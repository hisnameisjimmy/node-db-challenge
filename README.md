...
A relational database describes relationships between different datasets, or tables. SQL is just a query language to access the data in the database.

- [ ] Why do tables need a `primary key`?

So that each row can be referenced uniquely
...
You need an intermediary table that references the primary keys of each table relating to eachother.
